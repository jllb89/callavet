-- ============================================================
-- 0045: Phase 4 Clinical Encounters Backbone
-- ============================================================
-- Adds an encounter model and links notes/image-cases/care-plans
-- to a shared timeline entity for structured medical history.
