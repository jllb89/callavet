-- 0016_entitlement_security_definer.sql
-- Clean final: SECURITY DEFINER + direct user_subscriptions criteria (ignore cancel_at_period_end).
-- Ensures RLS visibility by executing with function owner's privileges.
-- Important: lock scope removed; safe increment guarded by entitlement quotas.
